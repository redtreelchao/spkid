...
class Collect_model extends CI_Model
{
	...
	{
		$sql = " SELECT fcp.*,pf.`product_name`,pf.`shop_price`,pf.`is_onsale`,pf.`product_desc_additional`,pf.`package_name`,pg.`img_url` FROM " .$this->_db->dbprefix('front_collect_product')." AS fcp ";
