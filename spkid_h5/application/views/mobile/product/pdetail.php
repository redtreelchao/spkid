                    ...
                    <div class="page-content " style=" padding-top:20px;">
                              ...
                              <div class="new-details-jl clearfix">
                                   ...
                                   <p class="new-details-moeny">
                                        ...
                                        <?php endif;?>
                                         ...
                                         <p class="new-details-ico clearxif"><span class="new-browse"><?php echo get_page_view('product',$p->product_id)?></span><span class="new-heart" onclick="add_to_collect2(<?= $p->product_id;?>,0,change_collect_status
                                         );"></span></p>
                                   </div>
                                   ...
                                   <?php if(count($campaign)):?>
                                   		<p class="new-sales">促销：
	                                       <?php foreach ($campaign as $k => $v):?>
	                                       			<span><?=$v['campaign_name']?></span>
	                                   		<?php endforeach;?>
                                   		</p>
                                   	<?php endif;?>
                              </div>
                        ...
                        <div class="new-details-xx clearfix">
                             <!-- 该产品优惠活动 start-->
							 	 ...
							 	 <?php foreach ($product_voucher as $pdt_val): ?>
                                 	<div class="new-details-jl clearfix">
	                                    <p class="new-vouchers"></p> 
	                                    <p class="new-vouchers-price">¥<?php echo round($pdt_val->voucher_amount,0);?>
	                                    <span style="font-size:14px">满<?php echo round($pdt_val->min_order,0);?>使用</span>
	                                    </p>
	                                      <div class="cash-coupon-right cash-coupon-right2"><a href="javascript:void(0)" class="cash-coupon-qx" onclick="return v_product_voucher('<?php echo $pdt_val->release_id;?>');">立即领取</a>
	                                	</div>
									</div>
                                      <?php endforeach; ?>
                              ...
                              <div class="new-details-color clearfix">
                                 ...
                                 <div class="new-details-color2 clearfix">
                                      ...
                                      <div class="new-number">
                                          <a href="javascript:void(0)" class="new-number-reduction btn-minus">-</a><a href="javascript:void(0)"><input name="number" type="text" class="new-number-input buy_num" value="1" id="choosed_num"></a><a href="javascript:void(0)" class="new-number-reduction new-number-reduction2 btn-plus">+</a>
                                      </div>
                                 </div>
