...
define('MEMCACHE_ADMIN_PASSWORD','admin');  	// Admin Password

define('DATE_FORMAT','Y/m/d H:i:s');
define('GRAPH_SIZE',200);
define('MAX_ITEM_DUMP',50);

$MEMCACHE_SERVERS[] = '192.168.20.111:11211'; // add more as an array
#$MEMCACHE_SERVERS[] = '192.168.1.100:11212'; // add more as an array
#$MEMCACHE_SERVERS[] = '192.168.1.100:11213'; // add more as an array
#$MEMCACHE_SERVERS[] = '192.168.1.100:11214'; // add more as an array

////////// END OF DEFAULT CONFIG AREA /////////////////////////////////////////////////////////////

///////////////// Password protect ////////////////////////////////////////////////////////////////
if (!isset($_SERVER['PHP_AUTH_USER']) || !isset($_SERVER['PHP_AUTH_PW']) ||
           $_SERVER['PHP_AUTH_USER'] != MEMCACHE_ADMIN_USERNAME ||$_SERVER['PHP_AUTH_PW'] != MEMCACHE_ADMIN_PASSWORD) {
