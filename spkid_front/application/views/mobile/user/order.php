    ...
    <div class="view view-main" data-page="index">
        <div class="pages">
            ...
            <div class="order-list ">
             ...
             <div class="hu-wddds">
                 <div class="hu-ddfk">
                      共<i><?php echo $order->product_num?></i>件商品<em>总金额:</em><span class="guanzhu-jiage">&yen;<?php echo $order->total_fee?></span><em>应付:</em><span class="guanzhu-jiage">&yen;<?php echo number_format($order->total_fee - $order->paid_price,2,'.','')?></span> 
                 </div>
            ...
            <?php foreach($pending as $order):?>
             ...
             <div class="hu-wddds">
                 <div class="hu-ddfk">
                      共<i><?php echo $order->product_num?></i>件商品<em>总金额:</em><span class="guanzhu-jiage">&yen;<?php echo $order->total_fee?></span><em>应付款:</em><span class="guanzhu-jiage">&yen;<?php echo number_format($order->total_fee - $order->paid_price,2,'.','')?></span>
                 </div>
                 <footer class="dd-line">
