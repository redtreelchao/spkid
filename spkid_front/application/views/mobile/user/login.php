...
<div class="view view-main signin2" data-page="login">
    <div class="content-block">
	 ...
	 <div class="logins-anniu">
	      <a href="/user/signin/register-step1" class="button button-big external zhuchen-baise">注册血色烂漫</a>
	      <a href="#" class="button button-big hu-denglu" onclick="checkLogin('<?=$back_url?>');">登陆血色烂漫</a>
	 </div>
