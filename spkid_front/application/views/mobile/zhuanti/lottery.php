...
<div class="page <?php if('lottery' != $cur_page) echo 'cached'?>" data-page="lottery">
    ...
    <div class="page-content" style="padding-top:0;">
         ...
         <div class="draw-public">
              <div class="common">
                   <ul class="draw-list">
                   <li><strong>参与人员</strong><span>11月16日15:00之前在血色烂漫移动端注册，并完善个人信息的所有新老会员。</span></li>
                   <li><strong>开奖时间</strong><span>11月16日下午16：00在血色烂漫牙医朋友QQ 群（群号：463540166），全程直播抽奖，记得到时来围观哦。<span></li>
                   ...
                   <li><span>血色烂漫服务</span><img src="<?php echo static_style_url('mobile/img/wechat-fwh.jpg')?>" width="100%" /></li>
                   ...
                   <li><span>微博血色烂漫</span><img src="<?php echo static_style_url('mobile/img/weibo-ewm.png')?>" width="100%" /></li>
                   </ul>
...
<div class="page <?php if('share' !== $cur_page) echo 'cached'?>" data-page="share">
    ...
    <div class="page-content" style="padding-top:0">
         ...
         <div class="draw-public">
              <div class="common">
                   <div class="fxyl"></div>
                   <div class="jiang-lb"><strong>好东西要和朋友分享哦！朋友中奖，截图发到（萌妹子悦悦微信号yueyawang_V）</strong>血色烂漫再送你<span>5000</span>积分，到你的个人中心账号！</div>
<div class="share_modal hcenter">
			<div class="jiathis_style_32x32">
				...
				<a class="jiathis_button_tsina"></a>
                   ...
                   <ul class="code2">
                   <li><img src="<?php echo static_style_url('mobile/img/wechat-fwh.jpg')?>" width="100%" /><p>血色烂漫服务号</p></li>
...
<div class="popover-inner tck-public">
     送个人中心专属空间，当天注册，当天拥有。世界很大，但我只想要一个属于我自己的温暖空间。送500积分，可以在血色烂漫上消费使用，当天注册，当天送礼。
</div>
</div>
...
<div class="popover-inner tck-public">
     ...
     <li>3、抽奖直播①：11月16日下午16：00在血色烂漫牙医朋友QQ 群（群号：463540166），全程直播抽奖，记得到时来围观哦。</li>
     <li>4、抽奖直播②：11月16日下午16点在血色烂漫新浪微博上直播（血色烂漫微博号：血色烂漫），如果加了关注，第一时间就可以通过新浪微博知道抽奖结果啦。 </li>
     <li>5、抽奖结果通知：血色烂漫微信服务号，血色烂漫微博，萌妹子悦悦都会通知中奖用户。 </li>
...
<div class="popover-inner tck-public">
 ...
 <p>把本条信息或页面链接，发到你的朋友圈或者某个特定朋友，如果你朋友中奖了，无论任何等级的产品，凭你分享至微信朋友圈或朋友个人的截图私信发给我们的萌妹子（悦悦微信号：yueyawang_V），血色烂漫再送你5000积分，到你的个人中心的账户！</p>
...
<div class="popover-angle"></div>
<div class="popover-inner tck-public">
<p>1、官方中奖公告将于11月16日晚上8点，在手机血色烂漫上，血色烂漫微信公众号（血色烂漫）上公布。赶紧关注血色烂漫公众号哦，中奖消息早知道。 </p>
