		...
		<div class="product-wrapper">
			<div class="product-overview clearfix">
				<div class="product-image fl-left">
					...
					<div class="product-thumbnails-box">
						<div class="thumbnails-control thumbnails-left">
							<i class="thumbnails-arrow left-arrow"></i>
						</div>
						<div class="thumbnails-control thumbnails-right">
							<i class="thumbnails-arrow right-arrow"></i>
						</div>
						<div class="product-thumbnails-window thumbnails-small">
							<div class="product-thumbnails" style="">
								<?php foreach ($g_list as $colorId => $v): ?>
								<?php foreach ($v as $k => $item): ?>
                                <? if ($k =='default') { ?>	
								    <div class="product-thumbnail-image <?php echo $k == 0 ? 'active' : '';?>"><img src="<?php echo img_url($item->img_url)?>"></div>   
								<?php }elseif($k =='part'){ foreach ($item as $val) { ?>
									
									<div class="product-thumbnail-image"><img src="<?php echo img_url($val->img_url)?>"></div>
				...
				<div class="product-info fl-left">
					...
					<div class="product-unit-box product-row">
						<label class="product-label ">型号</label>
						<div class="product-group">
							...
							<a href="javascript:void(0)" class="product-unit<?php if(!$v->sale_num): ?> sale-no<?php else: ?> buy_size <?php echo $default_sub_id == $k ? 'active' : ''?><?php endif; ?>
					...
					<div class="product-counter-box product-row">
			...
			<div class="navbar-wrapper">
				<ul class="navbar clearfix">
					<li><a href="javascript:void(0);" data-tag="detail" class="active">图文详情</a></li>
					<li><a href="javascript:void(0);" data-tag="evaluation" class="">注册证件</a></li>
					<li><a href="javascript:void(0);" data-tag="guide" class="">测试视频</a></li>
					<li><a href="javascript:void(0);" data-tag="comment" class="">留言评论</a></li>
				</ul>
			</div>
...
<!-- 购物车弹层开始 -->
<div id="dcart-box" class="modal v-pov" tabindex="-1" role="dialog" aria-hidden="true">
      <div class="modal-dialog">
        <div class="modal-content">
          <div class="modal-header v-close">
              ...
              <h4 class="modal-title">商品已成功加入购物车！</h4>
          </div>
          <div class="modal-body v-button">             
              <button class="btn cancel" type="submit" data-dismiss="modal">继续购物</button>
              <button class="btn btn-lg btn-blue cart_del_cfm" type="submit" onclick="window.location.href='/cart';">去购物车结算</button>
          </div>
        </div>
      </div>
</div>
