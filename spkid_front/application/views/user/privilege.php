<?php include APPPATH . 'views/common/user_header.php'?>           
			   	<div class="personal-center-right">
	            	...
	            	<div class="v-privilege-bottom">
	                	<h1 class="v-privilege-why">什么是血色烂漫优惠券</h1>
						<p>优惠券是血色烂漫通过买赠、活动参与、积分兑换等形式发放给用户，用于减免购买支付的惠民措施。从使用限额分为商品券和全场券；</p>
						<p>从销售主体进一步划分，分为限商品券和全场券；</p>
						<p>从优惠券存在形式划分，分为实体密码券和账户电子券两种。</p>
						<p>优惠券优惠部分不开具发票，以下为血色烂漫现有各优惠券详细说明：</p>
						<p>1、全场券</p>
						<p>血色烂漫站内通用，无使用限额、品类、地域限制。单张订单可以使用多张全场券，按面值总额减免支付，不能与商品券叠加使用。特殊商品不能使用。使用全场券提交订单时，若全场券金额大于订单需支付商品金额，差额不予退回。</p>
						<p>2、商品券</p>
