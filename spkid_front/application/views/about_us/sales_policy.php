    ...
    <div class="about-con">
        ...
        <div class="about-lb">
            ...
            <div class="sales-pilicy-right">
                ...
                <p>2.退款支持银行转账或返还到您的血色烂漫账户，不支持现金退款。</p>
                <p>3.如订单使用了血色烂漫优惠券，按实际交易额退款。</p>
                <p>4.如订单使用了积分抵扣，则退款时使用的积分返回积分帐户。</p>
                <p>5.折扣券不退还。如果含折扣券的订单，进行了部分退货，则将折扣券的优惠部分均摊到每件商品，根据优惠后的金额进行退款。</p>
                <p>6.发生退货时，所购商品所赠送的积分，血色烂漫将于退款时同步从您的积分账户里扣除。</p>
            ...
            <div class="sales-pilicy-right" style="display:none;">     
                ...
                <p>2.如发生退货，请将相关促销赠品等一并退回；血色烂漫将同时收回您购买此商品所获的相应积分；</p>
                <p>3.所有退换货须经血色烂漫客服中心确认后方可退回；</p>
                <p>4.在不违反国家相关法律法规的前提下，血色烂漫对商品退换原则保留最终解释权，感谢您对血色烂漫的支持！</p>
            </div>  
            <div class="sales-pilicy-right" style="display:none;">     
                <h3>退换货政策</h3>  
                <p>退换货原则：</p>
                <p>如您在血色烂漫购买的商品出现质量问题，请自售出之日起的15天内，致电血色烂漫客服中心说明情况，并准备好发票、退换货登记表等单据，并确保商品原件、配件、包装、说明书等完整无缺。</p>
                <p></p>
                <p>退换货规则：</p>
                ...
                <p> 3.  如商品并非血色烂漫提供或所退商品批号、型号与售出时不符将不予退换；</p>
                <p></p>
                <p>温馨提示：</p>
