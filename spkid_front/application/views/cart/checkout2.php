...
<div class="home-wrapper no-bottom" >     
     <div class="coupon-box">
          <div class="use-coupons"><div class="promo-code" onclick="openShutManager(this,'coupon-box-code',false,'-','+')">+</div>血色烂漫优惠<span class="coupon-box-title-tip"></span></div>        
                   ...
                   <div class="tab-nav">
                        ...
                        <div class="invoice-lb clearfix">
                           ...
                           <div class="v-button hu-button">
                                  ...
                                  <button class="btn cancel" type="submit" data-dismiss="modal">取消</button>
                                  <p class="wxts">温馨提示：发票金额不含血色烂漫积分，优惠券，现金券部分</p>
                           </div>
