...
<div class="main">
    <div class="main_title"><span class="l">热门关键字管理 >> 增加</span> <span class="r"><a href="hotword/index" class="return r">返回列表</a></span></div>
  <div class="blank5"></div>
	<?php print form_open_multipart('hotword/proc_add',array('name'=>'mainForm','onsubmit'=>'return check_form()'));?>
		<table class="form" cellpadding=0 cellspacing=0>
			...
			<tr>
				...
				<td class="item_input">
                <input name="hotword_name" class="textbox require" id="hotword_name" type="text" /></td>
			</tr>
			<tr>
				<td class="item_title">热门关键字URL:</td>
				<td class="item_input"><input name="hotword_url" class="textbox require" type="text" id="hotword_url" /></td>
			</tr>
			<tr>
