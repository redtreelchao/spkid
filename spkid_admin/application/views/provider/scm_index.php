...
<?php include(APPPATH.'views/common/header.php'); ?>
	...
	<script type="text/javascript">
		...
		listTable.url = 'provider/scm_index/<?php echo $filter['parent_id'];?>';
		function search(){
	...
	<div class="main">
		<div class="main_title"><span class="l">发货商列表</span><span class="r"><a href="provider/add/<?php print $filter['parent_id'];?>" class="add">新增</a></span></div>
		
		<div class="blank5"></div>
		<div class="search_row">
			<form name="search" action="javascript:search(); ">
			发货商编码：<input type="text" class="ts" name="provider_code" value="" style="width:100px;" />
			发货商名称：<input type="text" class="ts" name="provider_name" value="" style="width:100px;" />
...
<div class="am-btn-group">
						<a style="padding-left:0px;padding-right:5px;" class="am-icon-edit am-btn am-btn-xs" href="provider/edit/<?php print $row->provider_id; ?>/<?php print $row->parent_id; ?>" title="编辑">编辑</a>
						<?php if ($perm_delete): ?>
						...
						<?php endif ?>
						<?php if ($perm_provider_brand_setup): ?><a style="padding-left:0px;padding-right:5px;" class="am-icon-plus-chain am-btn am-btn-xs" href="shipper_brand/index/<?php print $row->provider_id; ?>/<?php print $row->parent_id; ?>" title="分配品牌">品牌</a><?php endif ?>
                        ...
                        <a style="padding-left:0px;padding-right:5px;" class="am-btn am-btn-xs am-btn-link am-icon-long-arrow-right" href="provider/scm_edit/<?php print $row->provider_id; ?>/<?php print $row->parent_id; ?>" title="直发设置">直发</a>
</div>
					</td>
				</tr>
				<?php endforeach; ?>
