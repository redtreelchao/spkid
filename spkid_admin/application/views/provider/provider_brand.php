...
<script type="text/javascript">
	...
	listTable.url = 'provider_brand/index/<?php echo $row->provider_id; ?>';
	function search(){
	...
	function remove_brand(brand_id){
	    if(!confirm('确定删除此供应商关联的品牌？'))return;
	    $.ajax({
	            url: '/provider_brand/remove_brand',
	            data: {is_ajax:1,rnd : new Date().getTime(),brand_id:brand_id,provider_id:provider_id},
	            dataType: 'json',
	            type: 'POST',
	            success: function(result){
        ...
        function update_commission(id) {
            ...
            $.ajax({
	            url: '/provider_brand/update_commission',
...
<div class="main">
	<div class="main_title"><span class="l">供应商管理 >> 分配品牌 </span><a href="provider/index" class="return r">返回列表</a></div>
	<div class="blank5"></div>
	<!--<div class="search_row">-->
	    <table class="dataTable">
		<tr class="row">
		    <td>供应商代码:<?php print $row->provider_code;?>&nbsp;&nbsp;&nbsp;&nbsp;</td>
		    <td>供应商名称:<?php print $row->provider_name;?>&nbsp;&nbsp;&nbsp;&nbsp;</td>
		    <td>状态:<?php print $row->is_use?"启用":"禁用" ; ?></td>
		</tr>
		<tr>
		    <td colspan="3">供应商关联品牌列表：<br />
                        <table class="dataTable" cellpadding=0 cellspacing=0>
                            ...
                            <tr class="row">
                                    ...
                                    <td>
                                        ...
                                        <a target="_blank" href="provider_brand/commission_history/<?php print $brand->id; ?>">查看扣点历史</a>
                                    </td>
                            </tr>
                            <?php endforeach; ?>
                        </table>
