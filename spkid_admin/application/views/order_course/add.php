...
<div class="main">
	<div class="main_title"><span class="l">课程订单管理 >> 新增订单 </span><span class="r"><a href="order_course/index" class="return">返回列表</a></span></div>
	<div class="blank5"></div>
	<?php print form_open('order_course/proc_add',array('name'=>'mainForm','onsubmit'=>'return check_form()'));?>
		<table class="form" cellpadding=0 cellspacing=0>
			...
			<tr>
				...
				<td class="item_input">课程产品 <input type="hidden" name="genre_id" value="<?php print GENRE_COURSE_ID;?>"></td>
			</tr>
			<tr>
			...
			<tr>
				...
				<td class="item_input">
					...
					<?php print form_button('mycancel','取消','class="am-btn am-btn-primary" onclick="location.href=\'order_course/index\';"'); ?>
				</td>
			</tr>
			<tr>
