...
<div class="main">
	<div class="main_title"><span class="l">课程订单管理 >> 新增课程订单 >> 支付方式 </span><span class="r"><a href="order_course/index" class="return">返回列表</a></span></div>
	<div class="blank5"></div>
	<div id="product_list">
		<?php include 'order_product.php' ?>
	</div>
	<?php print form_open('order_course/proc_payment',array('name'=>'mainForm','onsubmit'=>'return check_form()'),array('order_id'=>$order->order_id,'act'=>$act));?>
