...
<div class="main">
    ...
    <?php print form_open_multipart('mami_tuan_comment/proc_add', array('name' => 'mainForm', 'onsubmit' => 'return check_form()')); ?>
    <table class="form" cellpadding=0 cellspacing=0>
        ...
        <tr>
            ...
            <td class="item_input">
<input name="wechat_id" class="textbox require" id="wechat_id" value="" type="text"/>
            </td>
        </tr>
        <tr>
...
<input name="tuan_id" class="textbox require" id="tuan_id" value="" type="text"/>
        ...
        <tr>
            ...
            <td class="item_input">
<input name="comment_content" class="textbox require" id="comment_content" value="" type="text"/>
            </td>
        </tr>
        <tr>
            <td class="item_title">评论时间:</td>
            <td class="item_input">
<input name="comment_date" class="textbox require" id="comment_date" value="" type="text"/>
            </td>
        </tr>
