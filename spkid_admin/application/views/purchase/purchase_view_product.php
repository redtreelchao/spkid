...
<?php include(APPPATH.'views/common/header.php'); ?>
	...
	<div class="main">
		<div class="main_title">
                    ...
                    <span class="r">
                        <input id="print_provider_barcode_scaned" type="button" value="打印已收货条码" class="button10"/>
                        <input id="print_provider_barcode" type="button" value="打印需收货条码" class="button10"/>
