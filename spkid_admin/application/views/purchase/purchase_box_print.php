	...
	<div class="main">
		...
		<div align="center" class="full_width" id="printer_order">
			<table cellspacing="0" cellpadding="0" border="0" align="center">
				<tbody>
					<tr height="50">
						<td valign="bottom" valign="top" height="50" align="center" class="printer_title">小车拣货单</td>
					</tr>
					<tr height="20">
						<td width="1%" valign="top" height="20" align="left"><img src="index/barcode/<?php print $pick_sn;?>.html"></td>
					</tr>
					<tr>
			...
			<table width="100%" cellspacing="0" cellpadding="5" border="1" class="dingdan_nr">
				<tbody>
					...
					<tr>
						...
						<td align="center"><?php print $row->product_name; ?> <?php print $row->color_name; ?> <?php print $row->size_name; ?></p><img src="index/barcode/<?php print $row->provider_barcode;?>.html"></td>
						<td align="center"><span style="font-weight:bold"><?php print $row->location_name; ?></span></p>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;数量&nbsp;&nbsp;|&nbsp;&nbsp;订单格编号</p><span style="font-weight:bold"><?php print $row->product_number; ?></span>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;|&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<span style="font-weight:bold"><?php print $row->pick_cell; ?></span></td>
					</tr>
					<?php endforeach;?>
					</tbody>
			</table>
