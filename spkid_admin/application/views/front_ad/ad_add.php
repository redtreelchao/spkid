...
<script type="text/javascript">
	...
	function check_form(){
		...
		validator.selected('position_id', '请选择广告位置');
...
<div class="main">
        <div class="main_title"><span class="l">广告管理 >> 新增 </span><a href="<?php echo $position_id =='' ? 'front_ad/ad_index' : 'front_ad/operate_index/'.$position_id;?>" class="return r">返回列表</a></div>
	...
	<?php print form_open_multipart('front_ad/proc_ad_add/'.$position_id,array('name'=>'mainForm','onsubmit'=>'return check_form()'));?>
		<table class="form" cellpadding=0 cellspacing=0>
			...
			<tr>
			  ...
			  <td class="item_input">               <select name="position_id" id="position_id">
				  <option value="">--请选择--</option>
                  <?php
                  foreach($p_arr as $item):
				  ?>
			      <option <?php echo $item->position_id == $position_id ? 'selected="selected"' : '';?>  value="<?php echo $item->position_id?>"><?php echo $item->position_name?></option>
		      	  <?php
                  endforeach;
				  ?>
			    </select></td>
			...
			<tr>
				...
				<td class="item_input"><input name="ad_link" type="text"  class="textbox" id="ad_link" />链接必须以http://开头</td>
			</tr>
			<tr>
			...
			<tr>
			  ...
			  <td class="item_input"><?php print $this->ckeditor->editor('ad_code');?></td>
				...
				<td class="item_input">
					<?php print form_upload(array('name'=> 'pic_url','class'=> 'textbox'));?>
				</td>
			</tr>
			<tr>
