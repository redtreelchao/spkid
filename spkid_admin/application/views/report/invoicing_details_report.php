<?php include(APPPATH.'views/common/header.php'); ?>
	...
	<div class="main">
    <div class="main_title"><span class="l">报表管理 >> 财务进销存明细表(仓库口径)</span> </div>
    <div class="blank5"></div>
	  <div class="search_row">
			<form method="post" action="report/invoicing_details_report" name="theForm"  onsubmit = "return checkForm()">
		...
		<div id="listDiv">
			...
			<table width="1172" cellpadding=0 cellspacing=0 class="dataTable" id="dataTable">
				...
				<tr><td colspan="9" style="font-weight:bold;"><div align="center">合计</div></td>
