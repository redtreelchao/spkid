<?php include(APPPATH.'views/common/header.php'); ?>
    ...
    <div class="blank5"></div>
	  <div class="search_row">
			<form method="post" action="report/finance_invoicing_su_report" name="theForm"  onsubmit = "return checkForm()">
		...
		<div id="listDiv">
			...
			<table width="1172" cellpadding=0 cellspacing=0 class="dataTable" id="dataTable">
				...
				<tr>
			          ...
			          <td><div align="center"><?php echo $arr_rs['before_product_count_format'];?></div></td>
			          <td><div align="center"><?php echo $result_key;?></div></td>
			          <td><div align="center"><?php echo $arr_rs['num'];?></div></td>
			          <td><div align="center"><?php echo $arr_rs['count_foramt'];?></div></td>
			          <td><div align="center">&nbsp;</div></td>
			          <td><div align="center">&nbsp;</div></td>
			          <td><div align="center">&nbsp;</div></td>
			          <td><div align="center"><?php echo $arr_rs['after_product_number'];?></div></td>
			          <td><div align="center"><?php echo $arr_rs['after_product_count_format'];?></div></td>
			          <td><div align="center"><?php echo $arr_rs['after_product_cess_count_format'];?></div></td>
			    </tr>
				<?php endforeach; ?>
				<?php endif; ?>
				...
				<tr>
			          ...
			          <td><div align="center"><?php echo $arr_data['before_product_count_format'];?></div></td>
			          <td><div align="center">&nbsp;</div></td>
			          <td><div align="center">&nbsp;</div></td>
			          <td><div align="center">&nbsp;</div></td>
			          <td><div align="center">&nbsp;</div></td>
			          ...
			          <td><div align="center"><?php echo $arr_data['after_product_count_format'];?></div></td>
			          <td><div align="center"><?php echo $arr_data['after_product_cess_count_format'];?></div></td>
			    </tr>
				<?php endif; ?>
				<?php endforeach; ?>
				...
				<tr>
				    ...
				    <td><div align="center"><?php echo $count['total_before_amount_format'];?></div></td>
					<td><div align="center"><?php echo $cat_key;?></div></td>
					<td><div align="center"><?php echo $arr_cat['num'];?></div></td>
					<td><div align="center"><?php echo $arr_cat['count'];?></div></td>
					<td><div align="center">&nbsp;</div></td>
					<td><div align="center">&nbsp;</div></td>
					<td><div align="center">&nbsp;</div></td>
					<td><div align="center"><?php echo $count['total_after_num'];?></div></td>
					<td><div align="center"><?php echo $count['total_after_amount_format'];?></div></td>
					<td><div align="center"><?php echo $count['total_after_cess_amount_format'];?></div></td>
				</tr>
				<?php endforeach; ?>
				<?php endif; ?>
