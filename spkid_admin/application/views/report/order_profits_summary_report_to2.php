<?php include(APPPATH.'views/common/header.php'); ?>
	...
	<div class="main">
    <div class="main_title"><span class="l">报表管理 >> 订单利润汇总表（已完结，对应已完结退货，理论运费）</span> </div>
    <div class="blank5"></div>
	  	<div class="search_row">
			<form method="post" action="report/order_profits_summary_report_to2" name="theForm"  onsubmit = "return checkForm()">				
		...
		<div id="listDiv">
			...
			<table width="1172" cellpadding=0 cellspacing=0 class="dataTable" id="dataTable">
				...
				<?php endforeach; ?>
                                <tr>
					<td colspan="24" class="bottomTd"> </td>
				</tr>
			</table>
			<?php endif; ?>
  			<div class="blank5"></div>
