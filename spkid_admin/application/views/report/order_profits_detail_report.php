    ...
    <div class="blank5"></div>
	  	<div class="search_row">
			<form method="post" action="report/order_profits_detail_report" name="theForm"  onsubmit = "return checkForm()">
			    ...
			    &nbsp;
				商品品牌：<select name="brand_id" data-am-selected="{searchBox: 1,maxHeight: 300}">
					<option value="">--商品品牌--</option>
					<?php foreach($brand_list as $item) print "<option value='{$item->brand_id}'>{$item->brand_name}</option>";?>
				</select>
				&nbsp;
				供应商名称：<select name="provider_id" id="provider_id" data-am-selected="{searchBox: 1,maxHeight: 300}" >
