 ...
 <Worksheet ss:Name="订单销售利润明细表（已完结，退货单为负利润）">
  <Table ss:ExpandedColumnCount="16" x:FullColumns="1"
   ...
   <Row ss:AutoFitHeight="0">
    ...
    <Cell ss:StyleID="s71"><Data ss:Type="String">含税成本单价</Data></Cell>
    <Cell ss:StyleID="s71"><Data ss:Type="String">大类</Data></Cell>
    <Cell ss:StyleID="s71"><Data ss:Type="String">中类</Data></Cell>
   ...
   <Row ss:AutoFitHeight="0">
    ...
    <Cell ss:StyleID="s65"><Data ss:Type="Number"><?php print $op_val->cost_price; ?></Data></Cell>
    <Cell ss:StyleID="s65"><Data ss:Type="String"><?php print $op_val->class_one; ?></Data></Cell>
    <Cell ss:StyleID="s65"><Data ss:Type="String"><?php print $op_val->class_two; ?></Data></Cell>
