...
<?php include(APPPATH.'views/common/header.php'); ?>
	...
	<script type="text/javascript">
		...
		listTable.url = 'product/onsale_record_index';
		function search(){
	...
	<div class="main">
		<div class="main_title"><span class="l">商品管理 >> 上下架记录</span> </div>
		<div class="search_row">
			...
			<select name="sr_onsale">
				<option value="-1">记录类型</option>
				<option value="1">上架</option>
				<option value="0">下架</option>
			</select>
			操作人：<input type="text" name="create_admin" class="textbox" value="" style="width:100px;">
...
<?php endif; ?>
			<table id="dataTable" class="dataTable" width="100%" cellpadding=0 cellspacing=0>
				...
				<tr class="row">
					...
					<td><?php print $row->onsale_memo; ?></td>
					<td><?php print $row->admin_name; ?></td>
					<td><?php print $row->create_date; ?></td>
					<td><?php print $row->sr_onsale?'上架':'下架'; ?></td>
