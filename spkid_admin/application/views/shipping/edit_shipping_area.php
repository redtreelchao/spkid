...
<div class="main">
    <div class="main_title"><span class="l">配送方式区域管理 >> 编辑 </span><a href="shipping/operate/<?php echo $shipping_id;?>" class="return r">返回列表</a></div>
  <div class="blank5"></div>
	<?php print form_open_multipart('shipping/proc_edit_shipping_area/'.$shipping_area_id.'/'.$shipping_id,array('name'=>'mainForm','onsubmit'=>'return check_form()'));?>
		<table class="form" cellpadding=0 cellspacing=0>
			<tr>
				<td colspan=2 class="topTd"></td>
			</tr>
			<tr>
				<td width="150" class="item_title">配送区域名称:</td>
				<td class="item_input"><input name="shipping_area_name" class="textbox require" value="<?php echo $shipping_area->shipping_area_name?>" id="shipping_area_name" /></td>
			</tr>
			<tr>
		    ...
		    <label>
                    ...
                    <label>
                    <input type="radio" name="is_cod" value="1" id="is_cod_y" <?php echo $shipping_area->is_cod == 1 ? 'checked="checked"' : '';?> />
			        是
                    </label>
	          </td>
		    </tr>
			...
			<tr>
			  <td class="item_title">所辖地区:</td>
                ...
                <?php 
				foreach($all_shipping_area_region as $item){
