...
<?php include(APPPATH.'views/common/header.php'); ?>
	...
	<script type="text/javascript">
		...
		function search(){
			...
			listTable.filter['package_id'] = $.trim($(':input[name=package_id]').val());
		...
		function export_inv(){
		    ...
		    window.open("order_api/export_inv?inv_export_date="+inv_export_date);
		}
		//]]>
	</script>
	<div class="main">
...
<?php endif; ?>
			<table id="dataTable" class="dataTable" cellpadding=0 cellspacing=0>
				...
				<tr class="row">
					...
					<span class="pro_tip" rel="order_service/order_product/<?php print $row->order_id; ?>">
					...
					<td>
						<?php /*print $row->lock_admin?("<img src=\"public/images/lock.gif\" />".$row->lock_name):''换样式显示 By Rock*/ ?>
