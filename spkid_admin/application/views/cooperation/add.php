...
<div class="main">
	<div class="main_title"><span class="l">合作方式管理 >> 新增 </span><a href="cooperation/index" class="return r">返回列表</a></div>
	<div class="blank5"></div>
	<?php print form_open_multipart('cooperation/proc_add',array('name'=>'mainForm','onsubmit'=>'return check_form()'));?>
		<table class="form" cellpadding=0 cellspacing=0>
			...
			<tr>
				...
				<td class="item_input"><?php print form_input(array('name'=> 'cooperation_name','class'=> 'textbox require'));?></td>
			</tr>
			<tr>
