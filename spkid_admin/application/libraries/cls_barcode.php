...
class Cls_barcode {
	...
	public function setUnitWidth($unit_width)	
	{
		...
		if (!$this->is_set_height)
		{
			//$this->height = $this->unit_width*35;
                       // $this->height = $this->unit_width*60;
              $this->height = $this->unit_width*40;
		}
	}
	...
	public function createBarCode($code='',$text='',$type='B',$image_type ='jpeg',$file_name=null)
	{
		...
		for($i=0;$i<strlen($this->bin_code);$i++)
		{
			...
			$sx =$ex + 1;
                ...
                //file_put_contents("E://data.txt", print_r($data,TRUE));
		...
		{	
			...
			//imagechar($this->image,$this->font_type,6*$this->unit_width +$t_sx +$i*$t_x,60,$this->text{$i},$this->color);
