<?php if(!defined("BASEPATH")){ exit("No direct script access allowed"); }
     ...
     */
        class CI_Myupload extends CI_Upload {
             ...
             * @return  void
             */
                protected function set_multi_upload_data($key = 'userfield'){
                    $this->_multi_upload_data[$key][] = array(
             ...
             */
                public function do_multi_upload($field){
                    ...
                    for($i=0; $i<count($_FILES[$field]["name"]); $i++){
                        ...
                        $this->set_multi_upload_data($field);
                    }
