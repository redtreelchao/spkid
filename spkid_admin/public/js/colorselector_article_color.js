...
ColorSelecter.Show = function(sender)
{
  ...
  else
  {
    ...
    //document.body.appendChild(ColorSelecter.box);color_add
	document.getElementById("color_add").appendChild(ColorSelecter.box);
    ...
    for (var i = 0; i<myTable.rows.length; i++)
    {
      for (var j = 0; j < myTable.rows[i].cells.length; j++)
      {
        ...
        {
          document.getElementById("title_color").style.backgroundColor = this.bgColor;
		  document.getElementById("type_div").style.backgroundColor = this.bgColor;
          document.getElementById("title_color").value = this.bgColor;
          document.getElementsByName("title_color").item(0).style.color = this.bgColor;
