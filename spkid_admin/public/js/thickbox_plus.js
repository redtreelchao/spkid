...
function TB_show(caption, url) { //function called when the user clicks on a thickbox link
	try {
		...
		if(urlType == '.htm' || urlType == '.html'){//code to show html pages
			...
			$("#TB_window").append("<div id='TB_closeAjaxWindow'><span style='position: relative; right: 250px; '>"+caption+"</span><a href='#' id='TB_closeWindowButton'>关闭</a></div><div id='TB_ajaxContent' style='width:"+ajaxContentW+"px;height:"+ajaxContentH+"px;'></div>");
			$("#TB_closeWindowButton").click(TB_remove);
